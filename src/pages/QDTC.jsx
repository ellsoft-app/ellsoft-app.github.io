...
const QDTC = () => {
  return (
    <div>
      ...
      <p>
        EllSoft is committed to ensuring that the app is as useful and efficient
      ...
      <p>
        The Quick Draw app stores and processes personal data that you have
        ...
        features and it could mean that the Quick Draw app won't work properly
        or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that EllSoft will not
        ...
        or provided by your mobile network provider, but EllSoft cannot take
      ...
      <p>
        Along the same lines, EllSoft cannot always take responsibility for the
        ...
        the Service, EllSoft cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to EllSoft's responsibility for your use of the app, when
        ...
        it available to you. EllSoft accepts no liability for any loss, direct
      ...
      <p>
        ...
        using the app. EllSoft does not promise that it will always update the
